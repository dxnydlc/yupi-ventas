...
@section('content')
	...
	<div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Proveedores <small>Agregando una nuevo proveedor</small></h2>
                ...
                <div class="x_content">
                    ...
                    {!!Form::open(['route'=>'proveedor.store','method'=>'post','autocomplete'=>'off', 'class' => 'form-horizontal form-label-left' ,'data-parsley-validate' ])!!}
