...
@section('content')
	...
	<div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Proveedor <small>Editar un proveedor</small></h2>
                ...
                <div class="x_content">
                    ...
                    {!!Form::model ($proveedor , [ 'route' => ['proveedor.update' , $proveedor->id_proveedor ], 'method' => 'PUT' ,'autocomplete'=>'off', 'class' => 'form-horizontal form-label-left' ,'data-parsley-validate'])!!}
